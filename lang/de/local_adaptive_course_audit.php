...
$string['actiontour_loop1_addquiz_step_name_title'] = 'Test benennen';
$string['actiontour_loop1_addquiz_step_name_body'] = 'Geben Sie dem Test einen klaren Namen, damit er in diesem Abschnitt auffällt.';
$string['actiontour_loop1_addquiz_step_completion_title'] = 'Abschluss aktivieren';
$string['actiontour_loop1_addquiz_step_completion_body'] = 'Schalten Sie den Aktivitätsabschluss ein, damit Folgeaktivitäten darauf aufbauen können.';
$string['actiontour_loop1_addquiz_step_access_title'] = 'Voraussetzung hinzufügen';
$string['actiontour_loop1_addquiz_step_access_body'] = 'Nutzen Sie „Zugangsbeschränkungen", um den Test hinter die vorbereitende Aktivität zu legen.';
$string['actiontour_loop1_editquiz_step_access_title'] = 'Test absichern';
$string['actiontour_loop1_editquiz_step_access_body'] = 'Fügen Sie unter Zugangsbeschränkungen eine Abschlussbedingung hinzu, damit zuerst die Vorbereitung erledigt wird.';
$string['actiontour_loop1_editquiz_step_completion_title'] = 'Abschluss prüfen';
$string['actiontour_loop1_editquiz_step_completion_body'] = 'Stellen Sie sicher, dass der Abschluss automatisch beim Testende gesetzt wird, damit Folgeaktivitäten freigeschaltet werden.';
