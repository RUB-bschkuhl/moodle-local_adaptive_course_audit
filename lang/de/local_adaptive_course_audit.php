...
$string['reviewcoursematerial_leitfaden'] = 'Leitfaden adaptive Lehre (2025) (PDF)';
$string['reviewcoursematerial_miau'] = 'MIau: Adaptive Lehre – LEHRELADEN (PDF)';
...
$string['actiontour_loop_quiz_unlock_followups_addquiz_step_access_body'] = '<p>Nutzen Sie <strong>Zugangsbeschränkungen</strong>, um den Test hinter die vorbereitende Aktivität zu legen.</p><p>So verhindern Sie, dass Lernende direkt zum Test springen.</p>';
$string['actiontour_loop_quiz_unlock_followups_editquiz_step_access_title'] = 'Test absichern';
$string['actiontour_loop_quiz_unlock_followups_editquiz_step_access_body'] = '<p>Fügen Sie unter <strong>Zugangsbeschränkungen</strong> eine Abschlussbedingung hinzu, damit zuerst die Vorbereitung erledigt wird.</p><p><strong>Tipp:</strong> Abschlussbedingungen sind meist robuster als Datumsbedingungen.</p>';
...
// Tasks.
$string['task_cleanup_tours'] = 'Veraltete Adaptive course audit Touren bereinigen';

// Quiz unlock follow-ups rule strings.
$string['rule_loop_quiz_unlock_followups_name'] = 'Lernen, dann zeigen';
...
$string['rule_loop_quiz_unlock_followups_no_followups'] = 'Noch nichts hängt vom Test ab. Verknüpfen Sie Folgeaktivitäten mit dem Testergebnis.';
...
$string['rule_loop_branch_by_grade_missing_gradeitem'] = 'Für den Test „{$a}" konnte kein Gradebook-Eintrag gefunden werden. Prüfen Sie, ob der Test eine Maximalpunktzahl hat und im Gradebook geführt wird.';
$string['rule_loop_branch_by_grade_headline_missing'] = 'Noch keine notenbasierten Pfade';
$string['rule_loop_branch_by_grade_missing'] = 'Fügen Sie bei Folgeaktivitäten unter „Zugangsbeschränkungen" eine Bedingung „Bewertung" hinzu, damit Lernende je nach Ergebnis in „{$a}" unterschiedliche nächste Schritte sehen.';
...
$string['rule_loop_branch_by_grade_rationale'] = '<h5>Warum das wichtig ist</h5><p>Verzweigungen nach Testergebnis sind ein praxisnaher Weg, auf heterogene Vorkenntnisse zu reagieren.</p><p>Über Zugangsbeschränkungen können Lernende je nach Leistung zu Förder- oder Vertiefungsaktivitäten geleitet werden (vgl. Leitfaden adaptive Lehre, 2025; MIau.nrw).</p>';
...
$string['actiontour_gradegate_step_access_body'] = '<p>Öffnen Sie <strong>Zugangsbeschränkungen</strong> und fügen Sie eine Bedingung <strong>Bewertung</strong> (Min/Max) hinzu.</p><p><strong>Ergebnis:</strong> Lernende sehen je nach Punktzahl unterschiedliche Folgepfade.</p>';
...
$string['actiontour_diagnostic_step_access_body'] = '<p>Wenn gewünscht: Nutzen Sie <strong>Zugangsbeschränkungen</strong> (Abschluss), damit Lernende den Checkpoint vor dem Weiterarbeiten abschließen.</p><p><strong>Tipp:</strong> Optional lassen, wenn Überspringen nicht kritisch ist.</p>';
...
$string['actiontour_quizbehaviour_step_behaviour_body'] = '<p>Stellen Sie <strong>Wie Fragen verhalten</strong> auf einen adaptiven/interaktiven Modus (z. B. Adaptiver Modus oder Interaktiv mit mehreren Versuchen).</p><p><strong>Wirkung:</strong> Lernende erhalten unmittelbares Feedback und können erneut versuchen.</p>';
...
$string['rule_loop_quiz_random_questions_found'] = 'Test „{$a->quiz}" enthält {$a->count} Zufallsfragen-Slot(s).';
