...
$string['scenario_2_step4_button'] = 'Abschlussverfolgung oeffnen →';
...
$string['scenario_2_step5_button'] = 'Abschlussquiz hinzufuegen →';
$string['sequential_completion_tour_intro_title'] = 'Abschlussverfolgung vorbereiten';
$string['sequential_completion_tour_intro_content'] = 'Diese kurze Tour zeigt Ihnen, wo Sie Abschlussregeln fuer Aktivitaeten auf einen sequenziellen Kursverlauf abstimmen koennen.';
$string['sequential_completion_step1_title'] = 'Abschlussvorgaben pruefen';
$string['sequential_completion_step1_content'] = '<p>Pruefen Sie hier, wie Aktivitaeten in Ihrem Kurs ihren Abschluss markieren. Konsistente Abschlussregeln erleichtern es, spaetere Sektionen verlaesslich freizuschalten.</p>';
$string['sequential_completion_step2_title'] = 'Passenden Aktivitaetstyp oeffnen';
$string['sequential_completion_step2_content'] = '<p>Oeffnen Sie den Aktivitaetstyp, den Sie in Ihren sequenziellen Sektionen am haeufigsten einsetzen, und pruefen Sie, ob die Standardregeln zu Ihrem Konzept passen. So schaffen Sie eine wiederverwendbare Grundlage, bevor Sie einzelne Aktivitaeten feinjustieren.</p>';
$string['sequential_quiz_tour_intro_title'] = 'Abschlussquiz erstellen';
$string['sequential_quiz_tour_intro_content'] = 'Diese Tour begleitet Sie durch die wichtigsten Einstellungen fuer ein Abschlussquiz, das die Lernziele des Kurses ueberprueft.';
$string['sequential_quiz_step1_title'] = 'Abschlussquiz benennen';
$string['sequential_quiz_step1_content'] = '<p>Geben Sie dem Quiz einen klaren Namen, zum Beispiel: <em>Abschlussquiz: [Kurstopic]</em>.</p>';
$string['sequential_quiz_step2_title'] = 'Passendes Fragenverhalten waehlen';
$string['sequential_quiz_step2_content'] = '<p>Waehlen Sie das Fragenverhalten passend zu Ihrem Konzept. Nutzen Sie <strong>Adaptiver Modus</strong>, wenn das Abschlussquiz weiterhin geleitete Wiederholungen unterstuetzen soll, oder ein strengeres Verhalten, wenn es vor allem als Kontrollpunkt dient.</p>';
$string['sequential_quiz_step3_title'] = 'Anzahl der Versuche festlegen';
$string['sequential_quiz_step3_content'] = '<p>Legen Sie fest, wie viele Versuche Lernende erhalten sollen. Ein Versuch schafft einen klaren Abschlusskontrollpunkt, mehrere Versuche passen besser, wenn Lernende in den Loop zurueckkehren und erneut antreten sollen.</p>';
$string['sequential_quiz_step4_title'] = 'Abschluss als Bestehenssignal nutzen';
$string['sequential_quiz_step4_content'] = '<p>Konfigurieren Sie den Abschluss so, dass das Quiz als verlaessliches Bestehenssignal fuer das Kursende dienen kann. Darauf koennen Badges, Kursabschluss oder eine finale Freigabe aufbauen.</p>';
$string['sequential_quiz_step5_title'] = 'Speichern und zurueck';
$string['sequential_quiz_step5_content'] = '<p>Speichern Sie das Quiz mit <strong>Speichern und zum Kurs</strong>. Fragen koennen Sie anschliessend noch ergaenzen und dann das Ergebnis mit Ihrer Abschluss- oder Belohnungslogik verknuepfen.</p>';
...
$string['scenario_3_step3_button'] = 'Orientierungsseite hinzufuegen →';
...
$string['scenario_3_step4_button'] = 'Kompass-Quiz hinzufuegen →';
$string['scenario_3_step5_title'] = 'Feedback mit Inhaltsverweisen versehen';
$string['scenario_3_step5_content'] = '<p>Verlinken Sie in jeder Frage des Kompass-Quiz im <strong>Feedback</strong> (bei falscher und richtiger Antwort) den Inhalt, auf den sich die Frage bezieht.</p><ul><li><strong>Falsche Antwort:</strong> Verlinken Sie auf die Sektion/Aktivität, die das Thema behandelt.</li><li><strong>Richtige Antwort:</strong> Bestaetigen Sie und verlinken Sie optional auf Vertiefungsmaterial.</li></ul><p>Nutzen Sie den gefuehrten Spoke unten, um entweder die Quiz-Struktur oder direkt den Frageeditor zu oeffnen und diese Verweise dort einzupflegen.</p><div class="local-aca-tour-rationale"><h5>Warum das wichtig ist</h5><p>Handlungsleitendes Feedback mit gezielten Verlinkungen macht den Kompass zum Wegweiser: Lernende werden direkt zu den passenden Kursinhalten geleitet (vgl. Leitfaden adaptive Lehre, 2025; MIau.nrw).</p></div>';
$string['scenario_3_step5_button'] = 'Fragen-Feedback einrichten →';
$string['compass_orientation_tour_intro_title'] = 'Orientierungsaktivitaet erstellen';
$string['compass_orientation_tour_intro_content'] = 'Dieser kurze Spoke unterstuetzt Sie beim Erstellen einer Orientierungsseite, die Aufbau und Spielregeln Ihres Kompass-Kurses erklaert.';
$string['compass_orientation_step1_title'] = 'Orientierungsaktivitaet benennen';
$string['compass_orientation_step1_content'] = '<p>Geben Sie der Seite einen klaren Namen wie <em>So funktioniert dieser Kurs</em> oder <em>Orientierung im Kompass-Kurs</em>.</p>';
$string['compass_orientation_step2_title'] = 'Kurslogik erklaeren';
$string['compass_orientation_step2_content'] = '<p>Erklaeren Sie im Inhalt, wie der Kurs aufgebaut ist, welche Wahlfreiheit Lernende haben und wie der Kompass-Quiz zur Orientierung genutzt werden soll.</p>';
$string['compass_orientation_step3_title'] = 'Speichern und zum Kurs zurueck';
$string['compass_orientation_step3_content'] = '<p>Speichern Sie die Seite mit <strong>Speichern und zum Kurs</strong>. Nach der Rueckkehr auf die Kursseite steht der Compass-Hub wieder bereit.</p>';
$string['compass_quiz_tour_intro_title'] = 'Kompass-Quiz erstellen';
$string['compass_quiz_tour_intro_content'] = 'Dieser Spoke begleitet Sie durch die wichtigsten Einstellungen fuer ein Orientierungsquiz, das Lernenden den passenden Weg im Kurs zeigt.';
$string['compass_quiz_step1_title'] = 'Kompass-Quiz benennen';
$string['compass_quiz_step1_content'] = '<p>Geben Sie dem Quiz einen klaren, orientierungsbezogenen Namen, zum Beispiel: <em>Kompass-Quiz: Welches Thema passt als Naechstes?</em>.</p>';
$string['compass_quiz_step2_title'] = 'Unterstuetzendes Fragenverhalten waehlen';
$string['compass_quiz_step2_content'] = '<p>Waehlen Sie ein Fragenverhalten, das Orientierung und Reflexion unterstuetzt. Adaptive oder feedback-starke Einstellungen passen oft gut, weil der Kompass leiten und nicht nur pruefen soll.</p>';
$string['compass_quiz_step3_title'] = 'Genug Versuche erlauben';
$string['compass_quiz_step3_content'] = '<p>Erwaegen Sie mehrere Versuche, damit Lernende den Kompass wiederholt zur Orientierung nutzen koennen, waehrend sie den Kurs durchlaufen.</p>';
$string['compass_quiz_step4_title'] = 'Abschluss bewusst nutzen';
$string['compass_quiz_step4_content'] = '<p>Konfigurieren Sie den Abschluss so, dass der Kompass als Einstieg in den nicht-linearen Kurs dienen kann. Das laesst sich spaeter mit Verfuegbarkeitsregeln fuer Aktivitaeten oder Sektionen kombinieren.</p>';
$string['compass_quiz_step5_title'] = 'Speichern und zum Kurs zurueck';
$string['compass_quiz_step5_content'] = '<p>Speichern Sie das Quiz mit <strong>Speichern und zum Kurs</strong>. Nach der Rueckkehr auf die Kursseite koennen Sie mit dem naechsten Spoke weitermachen.</p>';
$string['compass_feedback_tour_intro_title'] = 'Fragen-Feedback mit Kursinhalten verknuepfen';
$string['compass_feedback_tour_intro_content'] = 'Dieser Spoke zeigt, wo Sie direkt in einer Frage Feedback hinterlegen, das Lernende zu den passenden Kursinhalten fuehrt.';
$string['compass_feedback_step1_title'] = 'Die Frage selbst bearbeiten';
$string['compass_feedback_step1_content'] = '<p>Hier bearbeiten Sie die Frage selbst. Formulieren Sie sie so, dass sie klar einem Thema oder einer Kompetenz Ihres Kurses zugeordnet ist.</p>';
$string['compass_feedback_step2_title'] = 'Allgemeines Feedback zur Orientierung nutzen';
$string['compass_feedback_step2_content'] = '<p>Hinterlegen Sie allgemeines Feedback, das erklaert, worum es in der Frage geht, und auf die Sektion oder Aktivitaet verweist, die als Naechstes hilfreich ist.</p>';
$string['compass_feedback_step3_title'] = 'Kombiniertes Feedback dort nutzen, wo es verfuegbar ist';
$string['compass_feedback_step3_content'] = '<p>Wenn dieser Fragetyp kombiniertes Feedback unterstuetzt, nutzen Sie die Bereiche fuer richtige, teilweise richtige und falsche Antworten, um unterschiedliche Materialien zu empfehlen.</p>';
$string['compass_feedback_step4_title'] = 'Antwortbezogene Hinweise einbauen';
$string['compass_feedback_step4_content'] = '<p>Nutzen Sie den Antwortbereich, um einzelne Optionen aussagekraeftiger zu machen. Verknuepfen Sie unpassende Antworten nach Moeglichkeit direkt mit dem Thema oder der Aktivitaet, die weiterhilft.</p>';
$string['compass_feedback_step5_title'] = 'Frage speichern';
$string['compass_feedback_step5_content'] = '<p>Speichern Sie die Frage, sobald die Verlinkungen und Hinweise gesetzt sind. Nach der Rueckkehr zur Kursseite koennen Sie den Compass-Hub erneut oeffnen.</p>';
$string['compass_feedback_gateway_tour_intro_title'] = 'Frageeditor aus dem Quiz heraus oeffnen';
$string['compass_feedback_gateway_tour_intro_content'] = 'Dieser kurze Gateway-Spoke startet auf der Quiz-Strukturseite und fuehrt Sie dann in den eigentlichen Frageeditor.';
$string['compass_feedback_gateway_step1_title'] = 'Von der Quiz-Struktur ausgehen';
$string['compass_feedback_gateway_step1_content'] = '<p>Nutzen Sie die Quiz-Strukturseite, um zu pruefen, welche Fragen zum Kompass gehoeren und an welcher Stelle sie in der Orientierung auftauchen.</p>';
$string['compass_feedback_gateway_step2_title'] = 'Eine Frage fuer detailliertes Feedback oeffnen';
$string['compass_feedback_gateway_step2_content'] = '<p>Mit dem Button unten oeffnen Sie eine neue Multiple-Choice-Frage im Editor, damit Sie guidance links direkt in den Feedback-Feldern hinterlegen koennen.</p>';
