...
$string['privacy:metadata:exportpath'] = 'Status der letzten Kurspruefung';
$string['privacy:metadata:local_adaptive_course_audit_review'] = 'Speichert den zuletzt gestarteten adaptiven Kurs-Review pro Nutzer und Kurs.';
$string['privacy:metadata:local_adaptive_course_audit_review:courseid'] = 'Die ID des Kurses, in dem die Pruefung gestartet wurde.';
$string['privacy:metadata:local_adaptive_course_audit_review:reviewurl'] = 'Die Review-URL zum Fortsetzen der zuletzt gestarteten Pruefung.';
$string['privacy:metadata:local_adaptive_course_audit_review:sectionid'] = 'Der fuer die Pruefung gewaehlte Abschnitt (0 bedeutet Kurspruefung).';
$string['privacy:metadata:local_adaptive_course_audit_review:timecreated'] = 'Der Zeitstempel, wann dieser Pruefungsdatensatz erstmals angelegt wurde.';
$string['privacy:metadata:local_adaptive_course_audit_review:timemodified'] = 'Der Zeitstempel, wann dieser Pruefungsdatensatz zuletzt aktualisiert wurde.';
$string['privacy:metadata:local_adaptive_course_audit_review:userid'] = 'Die Nutzer-ID der Person, die die Pruefung gestartet hat.';
...
$string['scenario_3_completion_step2_content'] = '<p>Speichern Sie die Aktivitaetseinstellungen mit <strong>Speichern und zum Kurs</strong>. Sie werden automatisch zum Themenabschnitt weitergeleitet, um dort die Zugriffsbeschraenkung zu ergaenzen.</p>';
