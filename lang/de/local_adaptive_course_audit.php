...
$string['privacy:metadata:local_adaptive_course_review'] = 'Speichert den zuletzt gestarteten adaptiven Kurs-Review pro Nutzer und Kurs.';
$string['privacy:metadata:local_adaptive_course_review:courseid'] = 'Die ID des Kurses, in dem die Pruefung gestartet wurde.';
$string['privacy:metadata:local_adaptive_course_review:reviewurl'] = 'Die Review-URL zum Fortsetzen der zuletzt gestarteten Pruefung.';
$string['privacy:metadata:local_adaptive_course_review:sectionid'] = 'Der fuer die Pruefung gewaehlte Abschnitt (0 bedeutet Kurspruefung).';
$string['privacy:metadata:local_adaptive_course_review:timecreated'] = 'Der Zeitstempel, wann dieser Pruefungsdatensatz erstmals angelegt wurde.';
$string['privacy:metadata:local_adaptive_course_review:timemodified'] = 'Der Zeitstempel, wann dieser Pruefungsdatensatz zuletzt aktualisiert wurde.';
$string['privacy:metadata:local_adaptive_course_review:userid'] = 'Die Nutzer-ID der Person, die die Pruefung gestartet hat.';
