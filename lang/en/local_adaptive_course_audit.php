...
$string['actiontour_loop1_addquiz_step_name_title'] = 'Name the quiz';
$string['actiontour_loop1_addquiz_step_name_body'] = 'Give the quiz a clear name so it stands out in this section.';
$string['actiontour_loop1_addquiz_step_completion_title'] = 'Enable completion';
$string['actiontour_loop1_addquiz_step_completion_body'] = 'Turn on activity completion so follow-up items can depend on this quiz.';
$string['actiontour_loop1_addquiz_step_access_title'] = 'Add a prerequisite';
$string['actiontour_loop1_addquiz_step_access_body'] = 'Use Restrict access to gate the quiz behind the prep activity.';
$string['actiontour_loop1_editquiz_step_access_title'] = 'Gate the quiz';
$string['actiontour_loop1_editquiz_step_access_body'] = 'Add a completion condition under Restrict access so learners finish the prep first.';
$string['actiontour_loop1_editquiz_step_completion_title'] = 'Check completion';
$string['actiontour_loop1_editquiz_step_completion_body'] = 'Ensure quiz completion is tracked automatically so follow-ups can unlock.';
