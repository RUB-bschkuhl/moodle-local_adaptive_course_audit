...
$string['loop_quiz_unlock_followups_summary'] = 'We look for a learning path where content leads into a quiz that unlocks the next steps – helping learners prove what they know before moving on.';
