...
$string['scenario_2_step5_button'] = 'Add final quiz →';
$string['sequential_completion_tour_intro_title'] = 'Set up completion defaults';
$string['sequential_completion_tour_intro_content'] = 'This short tour highlights where you can align activity completion with your sequential course path.';
$string['sequential_completion_step1_title'] = 'Review completion defaults';
$string['sequential_completion_step1_content'] = '<p>Use this page to review how activities in your course mark completion. Consistent completion rules make it easier to unlock later sections in a predictable way.</p>';
$string['sequential_completion_step2_title'] = 'Open a relevant activity type';
$string['sequential_completion_step2_content'] = '<p>Open the activity type you use in your sequential sections most often and check whether its default completion settings fit your concept. This gives you a reusable baseline before you fine-tune individual activities.</p>';
$string['sequential_quiz_tour_intro_title'] = 'Create the final quiz';
$string['sequential_quiz_tour_intro_content'] = 'This tour walks you through the key settings for a final quiz that checks the course learning goals.';
$string['sequential_quiz_step1_title'] = 'Name the final quiz';
$string['sequential_quiz_step1_content'] = '<p>Give the quiz a clear name, for example: <em>Final quiz: [Course topic]</em>.</p>';
$string['sequential_quiz_step2_title'] = 'Choose suitable question behaviour';
$string['sequential_quiz_step2_content'] = '<p>Choose the question behaviour that fits your concept. Use <strong>Adaptive mode</strong> if the final quiz should still support guided retries, or a stricter behaviour if it is mainly a checkpoint.</p>';
$string['sequential_quiz_step3_title'] = 'Set the number of attempts';
$string['sequential_quiz_step3_content'] = '<p>Decide how many attempts learners should get. One attempt creates a clear final checkpoint, while multiple attempts work better if learners should return to the loop and try again.</p>';
$string['sequential_quiz_step4_title'] = 'Use completion as the pass signal';
$string['sequential_quiz_step4_content'] = '<p>Configure completion so the quiz can act as a reliable pass signal for the end of the course. This is where badges, course completion, or a final release can build on the result.</p>';
$string['sequential_quiz_step5_title'] = 'Save and return';
$string['sequential_quiz_step5_content'] = '<p>Save the quiz using <strong>Save and return to course</strong>. You can still add questions afterwards and then connect the result to your completion or reward logic.</p>';
...
$string['scenario_3_step3_button'] = 'Add orientation page →';
...
$string['scenario_3_step4_button'] = 'Add compass quiz →';
$string['scenario_3_step5_title'] = 'Add content links to feedback';
$string['scenario_3_step5_content'] = '<p>In each question of the compass quiz, link the <strong>feedback</strong> (for both wrong and right answers) to the content the question relates to.</p><ul><li><strong>Wrong answer:</strong> Link to the section/activity covering this topic.</li><li><strong>Right answer:</strong> Confirm and optionally link to advanced material.</li></ul><p>Use the guided spoke below to open either the quiz structure page or the question editor and add those links directly where learners will see them.</p><div class="local-aca-tour-rationale"><h5>Why this matters</h5><p>Actionable feedback with targeted links turns the compass into a guide: learners are directed to the relevant course content (cf. Leitfaden adaptive Lehre, 2025; MIau.nrw).</p></div>';
$string['scenario_3_step5_button'] = 'Set up question feedback →';
$string['compass_orientation_tour_intro_title'] = 'Create the orientation activity';
$string['compass_orientation_tour_intro_content'] = 'This short spoke helps you create an orientation page that explains the structure and rules of your compass course.';
$string['compass_orientation_step1_title'] = 'Name the orientation activity';
$string['compass_orientation_step1_content'] = '<p>Give the page a clear name such as <em>How this course works</em> or <em>Orientation for the compass course</em>.</p>';
$string['compass_orientation_step2_title'] = 'Explain the course logic';
$string['compass_orientation_step2_content'] = '<p>Use the page content to explain the course structure, what learners can choose freely, and how the compass quiz should be used for orientation.</p>';
$string['compass_orientation_step3_title'] = 'Save and return to the course';
$string['compass_orientation_step3_content'] = '<p>Save the page with <strong>Save and return to course</strong>. When you return to the course page, the compass hub tour will be ready again.</p>';
$string['compass_quiz_tour_intro_title'] = 'Create the compass quiz';
$string['compass_quiz_tour_intro_content'] = 'This spoke guides you through the key settings for an orientation quiz that helps learners choose their own path.';
$string['compass_quiz_step1_title'] = 'Name the compass quiz';
$string['compass_quiz_step1_content'] = '<p>Give the quiz a clear orientation-focused name, for example: <em>Compass quiz: Find your next topic</em>.</p>';
$string['compass_quiz_step2_title'] = 'Choose a supportive behaviour';
$string['compass_quiz_step2_content'] = '<p>Select a question behaviour that supports orientation and reflection. Adaptive or feedback-rich settings often work well because the compass is meant to guide rather than merely test.</p>';
$string['compass_quiz_step3_title'] = 'Allow enough attempts';
$string['compass_quiz_step3_content'] = '<p>Consider allowing more than one attempt so learners can use the compass repeatedly as they work through the course.</p>';
$string['compass_quiz_step4_title'] = 'Use completion deliberately';
$string['compass_quiz_step4_content'] = '<p>Configure completion so the compass can act as the entry point into the non-linear course. This can later be combined with availability rules on activities or sections.</p>';
$string['compass_quiz_step5_title'] = 'Save and return to the course';
$string['compass_quiz_step5_content'] = '<p>Save the quiz with <strong>Save and return to course</strong>. When you come back to the course page, you can continue with the next spoke.</p>';
$string['compass_feedback_tour_intro_title'] = 'Link question feedback to course content';
$string['compass_feedback_tour_intro_content'] = 'This spoke shows where to add feedback directly inside a question so the compass can point learners to the right content.';
$string['compass_feedback_step1_title'] = 'Edit the question itself';
$string['compass_feedback_step1_content'] = '<p>This is the question form. Use it to phrase the prompt so it clearly maps to one topic or competency in your course.</p>';
$string['compass_feedback_step2_title'] = 'Use general feedback for orientation';
$string['compass_feedback_step2_content'] = '<p>Add general feedback that explains what the question is about and links to the section or activity learners should revisit or explore next.</p>';
$string['compass_feedback_step3_title'] = 'Add combined feedback where available';
$string['compass_feedback_step3_content'] = '<p>If this question type supports combined feedback, use the correct / partially correct / incorrect messages to send learners to different resources depending on their result.</p>';
$string['compass_feedback_step4_title'] = 'Add answer-specific cues';
$string['compass_feedback_step4_content'] = '<p>Use the answer section to make individual options more informative. Where appropriate, connect a wrong answer to the exact topic or activity that helps the learner recover.</p>';
$string['compass_feedback_step5_title'] = 'Save the question';
$string['compass_feedback_step5_content'] = '<p>Save the question when the links and guidance are in place. Returning to the course page lets you reopen the compass hub tour.</p>';
$string['compass_feedback_gateway_tour_intro_title'] = 'Open the question editor from the quiz';
$string['compass_feedback_gateway_tour_intro_content'] = 'This short gateway spoke starts on the quiz structure page and points you to the actual question editor.';
$string['compass_feedback_gateway_step1_title'] = 'Start from the quiz structure';
$string['compass_feedback_gateway_step1_content'] = '<p>Use the quiz structure page to review which questions belong to the compass and where they appear inside the orientation flow.</p>';
$string['compass_feedback_gateway_step2_title'] = 'Open a question for detailed feedback';
$string['compass_feedback_gateway_step2_content'] = '<p>Use the button below to open a new multichoice question in the editor so you can add guidance links directly inside the feedback fields.</p>';
