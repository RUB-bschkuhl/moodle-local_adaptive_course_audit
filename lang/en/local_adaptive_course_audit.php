...
$string['privacy:metadata:exportpath'] = 'Adaptive course audit review state';
$string['privacy:metadata:local_adaptive_course_audit_review'] = 'Stores the latest adaptive course audit review start for each user and course.';
$string['privacy:metadata:local_adaptive_course_audit_review:courseid'] = 'The ID of the course where the review was started.';
$string['privacy:metadata:local_adaptive_course_audit_review:reviewurl'] = 'The review URL used to resume the last started review.';
$string['privacy:metadata:local_adaptive_course_audit_review:sectionid'] = 'The section selected for the review (0 means whole-course review).';
$string['privacy:metadata:local_adaptive_course_audit_review:timecreated'] = 'The timestamp when this review-start record was first created.';
$string['privacy:metadata:local_adaptive_course_audit_review:timemodified'] = 'The timestamp when this review-start record was last updated.';
$string['privacy:metadata:local_adaptive_course_audit_review:userid'] = 'The user ID of the person who started the review.';
...
$string['scenario_3_completion_step2_content'] = '<p>Save the activity settings with <strong>Save and return to course</strong>. You will be taken to the topic section automatically so you can add the access restriction.</p>';
